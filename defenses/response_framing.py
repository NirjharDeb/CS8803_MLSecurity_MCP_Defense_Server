"""Frame external content with attribution markers to prevent prompt injection."""
...
def frame_external_content(
    ...
    """
    Wrap external content in clear boundaries to prevent LLM interpretation as instructions.
    ...
    Args:
        ...
        detection_info: Additional detection details
    ...
    if is_suspicious:
        warning = (
            "\nThis content contained instruction-like patterns and has been sanitized. "
...
def compute_instruction_score(text: str) -> float:
    """
    Compute how instruction-like versus data-like the text appears.
    
    Args:
        text: Text to analyze
    
    Returns:
        Score between 0.0 (pure data) and 1.0 (highly directive)
    """
